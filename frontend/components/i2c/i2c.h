...
/**
 * @brief Geef de reeds geïnitialiseerde I2C master bus handle terug.
 *
 * Moet aangeroepen worden nádat DEV_I2C_Init() is uitgevoerd.
 * Sensor-componenten (TSL2591, AHT20) gebruiken deze handle om zichzelf
 * via i2c_master_bus_add_device() aan de gedeelde bus toe te voegen.
 *
 * @return i2c_master_bus_handle_t  Bestaande bus handle (NULL als niet geïnitialiseerd).
 */
